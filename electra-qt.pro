...
HEADERS += src/qt/Electragui.h \
    ...
    src/qt/Electraaddressvalidator.h \
    src/alert.h \
    src/addrman.h \
    src/base58.h \
    src/bignum.h \
...
SOURCES += src/qt/Electra.cpp src/qt/Electragui.cpp \
    ...
    src/qt/Electraaddressvalidator.cpp \
    src/alert.cpp \
    src/version.cpp \
    src/sync.cpp \
    src/util.cpp \
    ...
    src/qt/Electrastrings.cpp \
    src/qt/Electraamountfield.cpp \
    src/wallet.cpp \
    src/keystore.cpp \
...
# also add new translations to src/qt/Electra.qrc under translations/
TRANSLATIONS = $$files(src/qt/locale/Electra_*.ts)
...
macx:ICON = src/qt/res/icons/Electra.icns
macx:TARGET = "Electra-Qt"
